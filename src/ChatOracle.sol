...
contract ChatOracle is IOracle {
    ...
    function addGroqResponse(
        ...
        console2.log("Agent contract:", callbackAddresses[promptId]);
        console2.log("promptCallBackId", promptCallBackId);
        console2.log("response.content", response.content);
        console2.log("errorMessage", errorMessage);
